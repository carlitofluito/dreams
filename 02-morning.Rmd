...
```{r edge, fig.cap= " If you read *Wait but Why*, shouldn’t be difficult to follow my train of thought. If you don’t, you should. Start [here](https://en.wikipedia.org/wiki/Wait_But_Why).", fig.margin = TRUE, out.width = "75%", fig.align='center', echo=FALSE}
